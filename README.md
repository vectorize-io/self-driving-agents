...
| Agent | Vibe |
|-------|------|
| 🤖 [AI Engineer](engineering/ai/ai-engineer.md) | Turns ML models into production features that actually scale. |
| ⚡ [Autonomous Optimization Architect](engineering/ai/autonomous-optimization-architect.md) | System governor that makes things faster without bankrupting you. |
| 📧 [Email Intelligence Engineer](engineering/ai/email-intelligence-engineer.md) | Turns messy MIME into reasoning-ready context. |
| 🔧 [Filament Optimization Specialist](engineering/ai/filament-optimization-specialist.md) | Streamlines complex Filament admin environments. |
| 🎙️ [Voice AI Integration Engineer](engineering/ai/voice-ai-integration-engineer.md) | Turns raw audio into structured, production-ready text. |

#### [`engineering/architecture`](engineering/architecture/) — System & code architecture

| Agent | Vibe |
|-------|------|
| ⚡ [Rapid Prototyper](engineering/architecture/rapid-prototyper.md) | Working prototype before the meeting's over. |
| 💎 [Senior Developer](engineering/architecture/senior-developer.md) | Laravel, Livewire, Three.js, advanced CSS. |
| 🏛️ [Software Architect](engineering/architecture/software-architect.md) | Systems that survive the team that built them. |

#### [`engineering/backend`](engineering/backend/) — APIs, data, databases

| Agent | Vibe |
|-------|------|
| 🧬 [AI Data Remediation Engineer](engineering/backend/ai-data-remediation-engineer.md) | Fixes broken data with surgical AI precision. |
| 🏗️ [Backend Architect](engineering/backend/backend-architect.md) | Databases, APIs, cloud, scale. |
| 🧱 [CMS Developer](engineering/backend/cms-developer.md) | Drupal & WordPress at enterprise scale. |
| 🔧 [Data Engineer](engineering/backend/data-engineer.md) | Pipelines that turn raw data into analytics-ready assets. |
| 🗄️ [Database Optimizer](engineering/backend/database-optimizer.md) | Indexes, query plans, schema design — no 3am pages. |

#### [`engineering/frontend`](engineering/frontend/) — Web & mobile UI

| Agent | Vibe |
|-------|------|
| 🖥️ [Frontend Developer](engineering/frontend/frontend-developer.md) | Responsive, accessible web apps, pixel-perfect. |
| 📲 [Mobile App Builder](engineering/frontend/mobile-app-builder.md) | Native-quality iOS and Android, fast. |
| 💬 [WeChat Mini Program Developer](engineering/frontend/wechat-mini-program-developer.md) | Mini Programs that thrive in the WeChat ecosystem. |

#### [`engineering/ops`](engineering/ops/) — DevOps, SRE, firmware, incidents

| Agent | Vibe |
|-------|------|
| ⚙️ [DevOps Automator](engineering/ops/devops-automator.md) | Infra automation so the team ships faster and sleeps better. |
| 🔩 [Embedded Firmware Engineer](engineering/ops/embedded-firmware-engineer.md) | Production-grade firmware for hardware that can't crash. |
| 🚨 [Incident Response Commander](engineering/ops/incident-response-commander.md) | Production chaos → structured resolution. |
| 🛡️ [SRE](engineering/ops/sre.md) | Error budgets fund velocity — spend them wisely. |

#### [`engineering/security`](engineering/security/) — AppSec, smart contracts, detection

| Agent | Vibe |
|-------|------|
| 🔒 [Security Engineer](engineering/security/security-engineer.md) | Threat modeling, code review, hunting — holds under adversaries. |
| ⛓️ [Solidity Smart Contract Engineer](engineering/security/solidity-smart-contract-engineer.md) | Battle-hardened EVM developer. |
| 🎯 [Threat Detection Engineer](engineering/security/threat-detection-engineer.md) | Catches attackers after they bypass prevention. |

#### [`engineering/workflow`](engineering/workflow/) — Code review, Git, docs, onboarding

| Agent | Vibe |
|-------|------|
| 👁️ [Code Reviewer](engineering/workflow/code-reviewer.md) | Mentor, not gatekeeper — every comment teaches. |
| 🧭 [Codebase Onboarding Engineer](engineering/workflow/codebase-onboarding-engineer.md) | New devs productive — read code, trace paths, state facts. |
| 🔗 [Feishu Integration Developer](engineering/workflow/feishu-integration-developer.md) | Feishu/Lark integrations — bots, approvals, data sync, SSO. |
| 🌿 [Git Workflow Master](engineering/workflow/git-workflow-master.md) | Clean history, atomic commits, branches that tell a story. |
...
| Agent | Vibe |
|-------|------|
| 📋 [Paid Media Auditor](paid-media/analytics/auditor.md) | Finds the waste before your CFO does. |
| 🔍 [Search Query Analyst](paid-media/analytics/search-query-analyst.md) | Mines queries for gold competitors miss. |
| 📡 [Tracking & Measurement Specialist](paid-media/analytics/tracking-specialist.md) | If it's not tracked correctly, it didn't happen. |

#### [`paid-media/channels`](paid-media/channels/) — Creative, PPC, paid social, programmatic
...
| Agent | Vibe |
|-------|------|
| 🔍 [Discovery Coach](sales/coaching/discovery-coach.md) | The one extra question that closes the deal. |
| 🏋️ [Sales Coach](sales/coaching/coach.md) | Makes the rep rethink the deal. |

#### [`sales/ops`](sales/ops/) — Pipeline analytics & sales engineering

| Agent | Vibe |
|-------|------|
| 📊 [Pipeline Analyst](sales/ops/pipeline-analyst.md) | Tells you your forecast is wrong before you do. |
| 🛠️ [Sales Engineer](sales/ops/engineer.md) | Wins the technical decision pre-procurement. |

#### [`sales/strategy`](sales/strategy/) — Account, deal, outbound, proposal

| Agent | Vibe |
|-------|------|
| 🗺️ [Account Strategist](sales/strategy/account-strategist.md) | Maps the org, finds the whitespace, expands. |
| ♟️ [Deal Strategist](sales/strategy/deal-strategist.md) | Qualifies like a surgeon, kills happy ears. |
...
| Agent | Vibe |
|-------|------|
| 🕹️ [XR Cockpit Interaction Specialist](spatial-computing/xr/xr-cockpit-interaction-specialist.md) | Immersive cockpit control systems. |
...
| Agent | Vibe |
|-------|------|
| 🔐 [Agentic Identity & Trust Architect](specialized/compliance-trust/agentic-identity-trust.md) | Every agent proves who, what, when. |
| ⚙️ [Automation Governance Architect](specialized/compliance-trust/automation-governance-architect.md) | Reliable systems > automation hype. |
| 🛡️ [Blockchain Security Auditor](specialized/compliance-trust/blockchain-security-auditor.md) | Finds the exploit before the attacker. |
| 📋 [Compliance Auditor](specialized/compliance-trust/compliance-auditor.md) | Readiness → SOC 2 certification. |
...
| Agent | Vibe |
|-------|------|
| 🎧 [Customer Service](specialized/customer-service/customer-service.md) | Problem → loyalty, with speed and care. |
...
| Agent | Vibe |
|-------|------|
| 🏥 [Healthcare Customer Service](specialized/healthcare/healthcare-customer-service.md) | Patients heard, respected, supported. |
| ⚕️ [Healthcare Marketing Compliance](specialized/healthcare/healthcare-marketing-compliance.md) | Legal in China's healthcare landscape. |

#### [`specialized/hr`](specialized/hr/) — Training, onboarding, recruiting
...
| Agent | Vibe |
|-------|------|
| 🌍 [Cultural Intelligence Strategist](specialized/regional/cultural-intelligence-strategist.md) | Detects invisible exclusion across cultures. |
| 🇫🇷 [French Consulting Market Navigator](specialized/regional/french-consulting-market.md) | Decodes the French consulting food chain. |
| 🇰🇷 [Korean Business Navigator](specialized/regional/korean-business-navigator.md) | Western directness ↔ Korean relationship dynamics. |
| 🌐 [Language Translator](specialized/regional/language-translator.md) | Precision with cultural respect. |
| 🎓 [Study Abroad Advisor](specialized/regional/study-abroad-advisor.md) | School, essays, visas — end to end. |

#### [`specialized/sales-ops`](specialized/sales-ops/) — Extraction & outreach
